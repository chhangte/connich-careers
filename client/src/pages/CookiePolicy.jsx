    ...
    <div className="min-h-screen bg-white pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="prose prose-blue max-w-none text-text-muted space-y-6">
          <p>
            This Cookie Policy explains how Connich Careers uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
          </p>

          <h2 className="text-xl font-bold text-text mt-8 mb-4">1. What are cookies?</h2>
          <p>
            Cookies are small data files that are placed on your computer or mobile device when you visit a website. Cookies are widely used by website owners in order to make their websites work, or to work more efficiently, as well as to provide reporting information.
          </p>

          <h2 className="text-xl font-bold text-text mt-8 mb-4">2. Why do we use cookies?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-text mt-8 mb-4">3. How can I control cookies?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-text mt-8 mb-4">4. Changes to this policy</h2>
          <p>
            We may update this Cookie Policy from time to time in order to reflect, for example, changes to the cookies we use or for other operational, legal or regulatory reasons. Please therefore re-visit this Cookie Policy regularly to stay informed about our use of cookies and related technologies.
          </p>

          <h2 className="text-xl font-bold text-text mt-8 mb-4">5. Contact us</h2>
          <p>
            If you have any questions about our use of cookies or other technologies, please email us at privacy@connich.com.
          </p>
        </div>
      </div>
    </div>
